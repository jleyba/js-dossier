        ...
        Property.newBuilder()
            .setBase(BaseProperty.newBuilder()
                ...
                .setDefinedBy(Comment.newBuilder()
                    .addToken(linkToken("Person", "class_Person.html#age"))))
            .setType(Comment.newBuilder()
                .addToken(numberToken()))
            .build());
  }
    ...
    assertThat(reportB.getProperties()).containsExactly(
        Property.newBuilder()
            .setBase(BaseProperty.newBuilder()
                ...
                .setVisibility(Visibility.PUBLIC)
                .setDefinedBy(Comment.newBuilder()
                    .addToken(linkToken("A", "class_A.html#a"))))
            .setType(Comment.newBuilder()
                .addToken(numberToken()))
            .build());
  }
    ...
    assertThat(report.getFunctions()).containsExactly(
        Function.newBuilder()
            .setBase(BaseProperty.newBuilder()
                ...
                .setVisibility(Visibility.PUBLIC)
                .setDefinedBy(Comment.newBuilder()
                    .addToken(linkToken("A", "class_A.html#sayHi"))))
            .setIsConstructor(false)
            .setReturn(Detail.newBuilder()
                .setType(Comment.newBuilder()
                    .addToken(stringToken()))
        ...
        Function.newBuilder()
            .setBase(BaseProperty.newBuilder()
                ...
                .addSpecifiedBy(Comment.newBuilder()
                    .addToken(linkToken("A", "interface_A.html#sayHi")))
                .addSpecifiedBy(Comment.newBuilder()
                    .addToken(linkToken("B", "interface_B.html#sayHi"))))
            .setIsConstructor(false)
            .setReturn(Detail.newBuilder()
                .setType(Comment.newBuilder()
                    .addToken(stringToken()))
    ...
    assertThat(report.getFunctions()).containsExactly(
        Function.newBuilder()
            .setBase(BaseProperty.newBuilder()
                ...
                .setVisibility(Visibility.PUBLIC)
                .addSpecifiedBy(Comment.newBuilder()
                    .addToken(linkToken("Greeter", "interface_Greeter.html#sayHi")))
                .setOverrides(Comment.newBuilder()
                    .addToken(linkToken("A", "class_A.html#sayHi"))))
            .setIsConstructor(false)
            .setReturn(Detail.newBuilder()
