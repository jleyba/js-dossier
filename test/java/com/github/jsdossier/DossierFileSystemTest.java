...
public class DossierFileSystemTest {
  ...
  @Inject @SourcePrefix private Path srcPrefix;

  @Inject @ModulePrefix private Path modulePrefix;

  @Inject private TypeRegistry typeRegistry;

  @Inject @Output private Path outputRoot;

  @Inject private CompilerUtil util;

  @Inject private DossierFileSystem sut;
  ...
  public void canGetThePathToARenderedSourceFile() {
    ...
    assertThat(path.toString())
        .isEqualTo(outputRoot.resolve("source/foo/bar/baz.js.src.html").toString());
  }
  ...
  public void getPathToAMarkdownPage() {
    MarkdownPage page =
        new MarkdownPage("Readme", outputRoot.getFileSystem().getPath("Readme.html"));
  ...
  public void canGetThePathToANominalType() {
    util.compile(fs.getPath("foo.js"), "goog.provide('foo.bar.Baz');", "foo.bar.Baz = class {};");

    NominalType type = typeRegistry.getType("foo.bar.Baz");
    assertThat(sut.getPath(type).toString())
        .isEqualTo(outputRoot.resolve("foo.bar.Baz.html").toString());
  }

  @Test
  public void canGetThePathToAClosureModule() {
    util.compile(fs.getPath("/input/src/foo.js"), "goog.module('a.b.c');", "exports.D = class {};");
    ...
    assertThat(sut.getPath(type).toString()).isEqualTo(outputRoot.resolve("a.b.c.html").toString());
  ...
  public void getModuleDisplayName_indexClashesWithSiblingInParentDir_es6Conventions() {
    ...
    util.compile(
        createSourceFile(p1, "export class X {}"), createSourceFile(p2, "export class Y {}"));
  ...
  public void getGoogModuleDisplayName() {
    util.compile(fs.getPath("foo.js"), "goog.module('foo.bar.baz');");
  ...
  public void getGoogModuleDisplayName_withLegacyNamespace_1() {
    util.compile(
        fs.getPath("foo.js"), "goog.module('foo.bar');", "goog.module.declareLegacyNamespace();");
  ...
  public void getRelativePath_fromGlobalType() {
    util.compile(fs.getPath("foo.js"), "class Baz {}");
  ...
  public void getQualifiedDisplayName_namespacedType() {
    util.compile(
        fs.getPath("foo.js"), "goog.provide('one.two.Three');", "one.two.Three = class {};");
  ...
  public void getQualifiedDisplayName_closureModuleType() {
    util.compile(fs.getPath("foo.js"), "goog.module('one.two');", "exports.Three = class {};");
