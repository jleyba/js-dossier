...
maven_jar(
    ...
    artifact = "com.google.javascript:closure-compiler:v20150729",
    sha1 = "c4c6fc679916adabb5b1fa993ec37f4263e4dd3f",
)

maven_jar(
    name = "closure_compiler_externs",
    artifact = "com.google.javascript:closure-compiler-externs:v20150729",
    sha1 = "d00fda57c3fb91223fc79be7adbf11e48b76552a",
)
...
maven_jar(
    name = "commonmark",
    artifact = "com.atlassian.commonmark:commonmark:0.2.0",
    sha1 = "506d5e9f5639c8a18c97de8f5e51f12b0ba824e2",
)

maven_jar(
    name = "commonmark_gfm_tables",
    artifact = "com.atlassian.commonmark:commonmark-ext-gfm-tables:0.2.0",
    sha1 = "b9a999c60310bce8f05513df7beb834cff0e900f",
)
