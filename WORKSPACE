...
# All maven_jars must have the 'dossier_' to avoid name conflicts with
# closure_repositories, which pulls in the dependencies, but as different
# versions. This ensure we won't have classpath conflicts by accidentally
# pulling in a jar from closure.
...
maven_jar(
    ...
    artifact = "com.google.javascript:closure-compiler-externs:v20160713",
    sha1 = "36c8fa2e53148f8f00070d1d5df6e065bd9ebfb3",
)
