        ...
        new AbstractShallowCallback() {
          ...
          public void visit(NodeTraversal t, Node n, Node parent) {
            if (isCall(n, "goog.module") && module == null) {
              ...
              Module.Type type =
                  nodeModules.contains(path) ? Module.Type.NODE : Module.Type.CLOSURE;
    ...
    traverseEs6(
        ...
        new NodeTraversal.AbstractShallowCallback() {
          ...
          private void visitModuleBody(Node body) {
            ...
            checkArgument(
                body.getParent().isScript(), "parent is not a script node: %s", body.getParent());
            ...
            module
                .setJsDoc(JsDoc.from(body.getParent().getJSDocInfo()))
            ...
            for (Map.Entry<String, String> alias : localAliases.entrySet()) {
              ...
              module.getAliases().addAlias(toContentsVar(module, alias.getKey()), alias.getValue());
            }
